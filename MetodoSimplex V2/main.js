...
function ejecucion() {
   ...
   restriccionesDesigualdad = restriccionesVanilla;
    ...
    mostrarVectorX(vectorX);
    document.getElementById("msgvectorx").style.display = 'block';
    mostrarVectorC(vectorC);
    document.getElementById("msgvectorc").style.display = 'block';
    mostrarVectorB(vectorB);
    document.getElementById("msgvectorb").style.display = 'block';
    ...
    mostrarListaVerticalVectorRestricciones(matrizA)
  ...
  function iterar(){
    ...
    if(minimoR!=0){
        ...
        document.getElementById("msgvectorx").style.display = 'none';
        document.getElementById("msgvectorc").style.display = 'none';
        document.getElementById("msgvectorb").style.display = 'none';
        ...
        if(puntoDegenerado(resultado5.toArray())==true){
          ...
          poliedroabierto.innerHTML = "<b>Caso especial punto degenerado</b>: Esto puede afectar la convergencia del método"
        }
        ...
        if(poliedroAbierto(resultado7.toArray())==true){
          ...
          poliedroabierto.innerHTML = "<b>Caso especial poliedro abierto:</b> No existe una solución óptima finita, no puede converger"
        ...
        mostrarMatrizBinv(matrizBnuminv);
        ...
        if(minimoR===0 && error===false){
          ...
          if (objetivoFuncion == "Minimización") {
            ...
            msgresultado.textContent = "Solucion optima Z= "+(-1*resultado6) 
            msgresultado2.innerHTML = mostrarSolucionesVariables(vectorXb,resultado5.toArray())
          }
          else{
            msgresultado.textContent = "Solucion optima Z="+resultado6
            msgresultado2.innerHTML = mostrarSolucionesVariables(vectorXb,resultado5.toArray())
          }
          ...
          poliedroabierto.textContent = "<b>Caso especial, problema no acotado.</b> La región de soluciones factibles no está acotada, lo que significa que la solución puede tender al infinito."
          document.getElementById("iterar").style.display = 'none';
          document.getElementById("solucionDirecta").style.display = 'none';
          document.getElementById("reset").style.display = 'block';
        }
